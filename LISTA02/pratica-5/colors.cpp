...
public:
    void sortColors(vector<int>& nums) {
        ...
        for(int i = 0; i < 3; i++){
            if(arryValores.at(i) != 0){

                for(ultimaPosicao; ultimaPosicao < nums.size() && arryValores.at(i) > 0; ultimaPosicao++, arryValores.at(i)--){
                    nums.at(ultimaPosicao) = i;
                }
